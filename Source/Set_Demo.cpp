...
//	Subjects subjects{"Biology", "Physics", "Chemistry", "Mathematics", "Astronomy", "Drama", "Politics", "Philosophy",
//					  "Economics"};
...
//	for (const auto &student : students) { // Verify the minimum number of Subjects has been met
